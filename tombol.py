...
print('\t Youtube :https://www.youtube.com/channel/UCHIwB1aPQC6EOou0xM3hPnw')
print('\t Github : https://github.com/Hackers20')
print(a+'-'*50)
print('\nProses ...')
sleep(1)
...
os.system('xdg-open https://www.youtube.com/channel/UCHIwB1aPQC6EOou0xM3hPnw')
print(c+'Thanks You\n')
